...
$sql .= ' GROUP BY b.id, b.title, b.author_id, b.category_id, b.isbn, b.description, b.price, b.image_path, b.total_copies, b.available_copies, b.created_at, a.name, c.name ORDER BY b.title ASC';
...
<section class="filter-card">
    ...
    <span class="book-preview">
        <img src="<?= e(url('assets/uploads/book_69ea91b7745099.90013306.jpg')) ?>" alt="">
        <img src="<?= e(url('assets/uploads/book_69e39b1990ca05.53518561.jpg')) ?>" alt="">
        <img src="<?= e(url('assets/uploads/book_69ea128d007be9.46513303.jpg')) ?>" alt="">
        <img src="<?= e(url('assets/uploads/book_69e3ef11bbe084.28005468.jpg')) ?>" alt="">
    </span>
</a>
                </div>
            </div>
