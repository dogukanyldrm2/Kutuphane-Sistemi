...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $imagePath = (string) ($book['image_path'] ?? '');
...
$currentImage = (string) ($book['image_path'] ?? '');
$currentDescription = trim((string) ($_POST['description'] ?? $book['description']));
$currentSummary = trim((string) ($_POST['summary'] ?? ($book['summary'] ?? '')));
    ...
    <div class="form-card">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <small class="muted">Yeni görsel seçersen mevcut kapak değiştirilir. Maksimum 5 MB.</small>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="summary" name="summary" rows="8" placeholder="Kitabın sağ tarafta gösterilecek özetini yazın..."><?= e($currentSummary) ?></textarea>
            </div>
